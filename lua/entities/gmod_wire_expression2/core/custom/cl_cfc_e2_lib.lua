...
E2Helper.Descriptions["cosr(xv2)"]             = "Returns a vector2 with the cosine of x and y. Inputted in radians"
E2Helper.Descriptions["secr(xv2)"]             = "Returns a vector2 with the secant of x and y. Inputted in radians"
E2Helper.Descriptions["sinr(xv2)"]             = "Returns a vector2 with the sine of x and y. Inputted in radians."
E2Helper.Descriptions["cscr(xv2)"]             = "Returns a vector2 with the cosecant of x and y. Inputted in radians."
E2Helper.Descriptions["tanr(xv2)"]             = "Returns a vector2 with the tangent of x and y. Inputted in radians."
E2Helper.Descriptions["cotr(xv2)"]             = "Returns a vector2 with the cotangent of x and y. Inputted in radians."
