...
E2Helper.Descriptions["npcSetGlobalSquad(e:n)"]        = "Sets the squad number of an NPC. Admin only."
E2Helper.Descriptions["npcGetGlobalSquad(e:n)"]        = "Returns an NPC's squad. Admin only. "
