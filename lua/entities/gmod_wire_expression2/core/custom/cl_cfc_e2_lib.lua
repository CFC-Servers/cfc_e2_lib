...
E2Helper.Descriptions["e:setFairPos(v)"]       = "Sets an entity (nonplayer)s position, as long as it is in the fair limits. Outputs a 1 for success, -1 for target pos out of bounds, -2 for target entity out of bounds, -3 for target being a player."
